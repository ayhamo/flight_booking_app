...
class FeaturedTiles extends StatelessWidget {
  ...
  final List<String> assets = [
    ...
    'https://upload.wikimedia.org/wikipedia/tr/3/3d/Emirates_logo.png',
    'https://upload.wikimedia.org/wikipedia/commons/c/c2/Qatar_Airways_Logo.png',
  ];

  final List<String> title = ['Turkish Airlines', 'Emirates', 'Qatar Airways'];
